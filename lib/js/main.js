var screenheight= window.innerHeight;
    document.getElementById("container_height").style.minHeight = screenheight +"px";
//Use Strict Mode
(function($) {
  "use strict";
...
//==============___Contact Form Validator and Ajax Sender___================
  $("#contactForm").validate({
    submitHandler: function(form) {
      // $("#load_sending").removeClass("form-result modal-wrap");
      $("#load_sending").fadeIn(300);
      $.ajax({
        type: "POST",
        url: "lib/phpMail/SendMail.php",
        data:{
        ...
        success: function (data) {
          $("#sending_image").addClass("hidden");
          // console.log(JSON.stringify(data));
          if (data.response == "success") {
            $("#contactSuccess").fadeIn(300);
            $("#load_sending").addClass('hidden');
          ...
          // $("#load_sending").addClass("form-result modal-wrap");
        },
